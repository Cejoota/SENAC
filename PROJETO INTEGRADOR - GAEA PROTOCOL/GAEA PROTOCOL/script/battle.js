// =====================================================================
// BATTLE.JS - VERSÃO COM CORREÇÃO NO EFEITO DE COMPRA DE CARTA
// =====================================================================
...
// CORREÇÃO: Lógica de verificação de turno removida daqui.
function drawCard() {
...
// --- 5. INICIALIZAÇÃO DO JOGO E RECOMPENSAS ---
...
    
    // CORREÇÃO: A lógica de verificação de turno foi movida para DENTRO do listener do deck.
    const deckElement = document.getElementById('deck-draw');
    if (deckElement) {
        deckElement.addEventListener('click', () => {
            if (!isPlayerTurn) {
                console.log("Aguarde o seu turno para comprar cartas.");
                animateDamage(deckElement, 'animate__headShake');
                return;
            }
            drawCard();
        });
